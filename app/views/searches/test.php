				...
				<nav class="pagination pagination-next-prev">
					<ul>
						 ...
						 <?php
						 	...
						 	$num_rows = $data['listing_num_rows']->TotalCount;
				          ...
				          {
				            echo "
				            <a href='".URLROOT."/searches?Page=".$prev_page."&location=".$data['location']."&row_start=".$row_start."&row_end=".$row_end."' class='prev'><button class='button'>Prev</button></a> ";
				          }

				          for($i=1; $i<=$num_pages; $i++){
				            if($i != $page)
				            {
				               echo "<a href='".URLROOT."/searches?Page=".$i."&location=".$data['location']."&row_start=".$row_start."&row_end=".$row_end."' class=''>".$i."</a>";
				            }
				            else 
				            {
				          ...
				          if($page!=$num_pages)
				          {
				            echo " <a href ='".URLROOT."/searches?Page=".$next_page."&location=".$data['location']."&row_start=".$row_start."&row_end=".$row_end."'  class='next'><button class='button'>Next</button></a> ";
				          }
				          //$conn = null;
				        ?>
					</ul>
