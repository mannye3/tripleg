	...
	<div class="col-md-12">
		...
		<div class="submit-section">
			...
			<div class="form">
				...
				<h5>Property Title 
            <input type="text" class="form-control" value="<?php echo $data['pro_info']->title; ?>" name="title" id="username2"   />
			</div>
			...
			<div class="row with-forms">
				...
				<div class="col-md-4">
					...
					<div class="select-input disabled-first-option">
						<input  onkeypress="return (event.charCode == 8 || event.charCode == 0 || event.charCode == 13) ? null : event.charCode >= 48 && event.charCode <= 57" data-unit="Naira" value="<?php echo $data['pro_info']->price; ?>" name="price" type="text">
				...
				<div class="col-md-4">
					...
					<select name="type" class="chosen-select-no-single" >
						<option value="<?php echo $data['pro_info']->type; ?>"><?php echo $data['pro_info']->type; ?></option>		
				...
				<div class="col-md-4">
					...
					<select  name="purpose" class="chosen-select-no-single" >
						<option value="<?php echo $data['pro_info']->purpose; ?>"><?php echo $data['pro_info']->purpose; ?></option>		
			...
			<div class="row with-forms">
				...
				<div class="col-md-6">
					...
					<select name="rooms" class="chosen-select-no-single" >
						<option value="<?php echo $data['pro_info']->rooms; ?>"><?php echo $data['pro_info']->rooms; ?></option>	
						<option>1</option>
						<option>2</option>
						<option>3</option>
						<option>4</option>
				...
				<div class="col-md-6">
					...
					<select name="bathrooms"  class="chosen-select-no-single" >
						<option value="<?php echo $data['pro_info']->bathrooms; ?>"><?php echo $data['pro_info']->bathrooms; ?></option>	
						<option>1</option>
						<option>2</option>
						<option>3</option>
						<option>4</option>
		...
		<div class="submit-section">
			...
			<div class="row with-forms">
				...
				<div class="col-md-12">
					...
					<input  type="text"  value="<?php echo $data['pro_info']->address; ?>" onFocus="initializeAutocomplete()" id="locality"  name="address" >
		...
		<div class="submit-section">
			...
			<div class="form">
				<h5>Description</h5>
				<textarea name="editor1"><?php echo $data['pro_info']->details; ?></textarea>
                          <script>
